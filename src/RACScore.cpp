...
RACScore::RACScore( BglGraph const * const ptrGraph, 
...
void 
RACScore::GetTrainAttriByEdge( vector<double>& vecAttributes, 
...
void
RACScore::GetAttributeByEdge( vector<double>& vecAttributes )
{
...
void
RACScore::GetLabelByEdge( vector<double>& vecLabels)
{
...
void 
RACScore::GetProblemLabelByEdge(vector<double>& vecLabels)
{
...
double
RACScore::GetMaxRAScore( const int level)
{
  vector<int> vecCommNeighbors;
...
void 
RACScore::GetNeighbors(const BglVertex& selfVertex, 
...
int 
RACScore::GetNumCommNeighbors(const BglVertex& selfVertex, 
...
void
RACScore::BFS( const BglVertex& curVertex, vector<int>& vecNeighbors,
...
double
RACScore::GetSumInvDegree( const vector<int>& vecCommNeighbors)
{
  BglVertex u;
  double degree = 0.0;
  double sum = 0.0;
